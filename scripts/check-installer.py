...
def main() -> int:
    ...
    # --all -y --dir <tmp> installs exactly 31 skills
    ...
    # non-interactive fallback installs all 31 skills there before the
    ...
    print(
        ...
        "31 skills with byte-identical required artifacts across 5 families "
