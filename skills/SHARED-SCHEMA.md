...
The five `parsing-*` skills intentionally carry a copy of the same vendor-neutral intermediate schema at:
...
- After changing it, copy the same content to the Cisco, Firepower, Fortinet, and Palo Alto parsing skills.
